...
OUTPUT_FOLDER=${SCRIPT_PATH}/output/with-neighborhood-flow-always-improve
...
for SHAPE in ${SHAPES}
do
    $APP_GRAPH_FLOW -S${SHAPE} -h0.125 -b1 -a${ALPHA} -r16 -v5 -O2 -N2 -n4 -i-1 -B30 -s ${DATA_OUTPUT_FOLDER}/${SHAPE}
