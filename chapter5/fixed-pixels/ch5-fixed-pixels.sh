...
function run_flow()
{
    ...
    do
        ...
        OUTPUT_FOLDER=${SCRIPT_PATH}/output/fixed-pixels/$energy/len_pen_$len_pen/$inName
        ...
        $SUMMARY_APP -j10 -d${DATA_OUTPUT_FOLDER}/pixelMask.pgm ${DATA_OUTPUT_FOLDER} ${OUTPUT_FOLDER}/summary.eps
