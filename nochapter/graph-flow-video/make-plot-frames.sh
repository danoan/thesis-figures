...
{
    FILE=$1
    m=$( awk '{ print $2 }' $FILE | sort -r | head -n2 | tail -n1)
    echo $m
}
...
DATA_FILE=${SCRIPT_PATH}/data/${SHAPE}/energy.txt
...
convert -delay 10 ${SCRIPT_PATH}/data/${SHAPE}/*.pgm ${OUTPUT_PATH}/flow.gif

echo "Creating plot gif..."
convert -delay 10 ${FRAME_OUTPUT_PATH}/*.png ${OUTPUT_PATH}/plot.gif